  ...
  <body>
    ...
    <div id="real_body">
      ...
      <section class="about content">
        ...
        <div class="about_item" id="ancient_traces">
          ...
          <div>
            ...
            <svg id="symbol_lite" class="sacred_symbol" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="#999">
      ...
      -->
        <div class="about_item" id="betrayal">
          ...
          <div>
            ...
            <svg class="sacred_symbol" xmlns="http://www.w3.org/2000/svg" width="43.27" height="43.27" viewBox="0 0 43.27 43.27">
        ...
        <div class="about_item" id="two_birds">
          <div>
            ...
            <svg class="sacred_symbol" xmlns="http://www.w3.org/2000/svg" width="32" height="60" viewBox="0 0 32 60">
              <defs>
                <style>
                  .cls-1 {
                    fill: none;
        ...
        <div class="about_item" id="defeat">
          ...
          <div>
            ...
            <svg class="sacred_symbol" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="58.84" height="29.37" viewBox="0 0 58.84 29.37">
        ...
        <div class="songs_item" id="broken">
          <div>
            ...
            <div class="sacred_symbol_container">
              ...
              <svg class="sacred_symbol" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                <path d="M127.82,318.56v21.29h-4V318.56a19.3,19.3,0,1,0,4,0Z" transform="translate(-106.51 -318.56)"/>
              </svg>
            </div>
      ...
      <section class="puzzle content">
        ...
        <div class="puzzle_item present_note">
          I was a big Nietzsche fanboy back then and wrote aphorisms on everything. <br>
          But this one had strange symbols sketched out beneath it. I can't remember where they came from...
        </div>
